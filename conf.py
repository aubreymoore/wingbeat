...
BLOG_TITLE = "wingbeat"  # (translatable)
...
BLOG_EMAIL = "aubreymoore2013@google.com"
BLOG_DESCRIPTION = "This site documents development of an insect wingbeat waveform recorder."  # (translatable)
